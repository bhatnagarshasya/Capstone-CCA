...
def Prediction(MLTechnique):
    ...
    req = requests.get(f"http://127.0.0.1:8080/TrainData/{MLTechnique}/{session['OutputFields']}")
...
@app.route("/TrainData/<str: MLTechnique>/<str: Data>")
def DataTrainer(MLTechnique, Data):
    ...
    return 'Hey, am I getting something  '#json.dumps(data)
