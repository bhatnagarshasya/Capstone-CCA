...
def Prediction(MLTechnique):
    ...
    session['MLOutput'] = requests.get(f"http://127.0.0.1:8080/TrainData/{Data}").json()
    return redirect("/mlTrainer")
